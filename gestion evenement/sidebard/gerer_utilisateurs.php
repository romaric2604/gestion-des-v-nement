...
if (isset($_GET['action']) && $_GET['action'] == 'supprimer' && isset($_GET['id'])) {
    ...
    try {
        ...
        $stmt_acteur = $conn->prepare("DELETE FROM client WHERE id = ?");
...
$sql = "SELECT id, nom, prenom, email, numero, domicile, photo FROM client ORDER BY nom ASC";
            ...
            <ul class="user-list">
                <?php if (!empty($utilisateurs)): ?>
                    <?php foreach ($utilisateurs as $user): ?>
                        <li class="user-item">
                            <div class="user-info">
                                <img src="../images/<?php echo htmlspecialchars($user['photo'] ?: 'images/default.png'); ?>" alt="Photo">
