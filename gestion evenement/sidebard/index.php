...
if ($type === 'client') {
    ...
    $sql = "SELECT a.nom, a.prenom, a.photo, a.email, a.mot_de_passe FROM acteur a  WHERE a.id = ?";
} elseif ($type === 'admin') {
            ...
            <div class="sidebar__content">
               <div>
                  ...
                  <div class="sidebar__list">
                     ...
                     <?php 
                        if ($type == 'admin' ) {
                            echo '<a href="#" class="sidebar__link active-link"  onclick="showiframe(\'apercus\',\'admin_dashboard.php\')">
                        <i class="ri-pie-chart-2-fill"></i>
                        <span>Tableau de bord</span>
                     </a>';
                        }
                     ...
                     <?php 
                        if ($type == 'acteur' ) {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'mes_taches.php\')">
                     ...
                     <?php 
                        if ($type == 'client' ) {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'mes_evenement.php\')">
                        <i class="ri-wallet-3-fill"></i>
                        <span>Mes évènement</span>
                     </a>';
                        }
                     ?>
                     <?php 
                     ...
                     ?>
                      <?php 
                        if ($type == 'acteur' ) {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'tache_recente.php\')">
                        <i class="ri-arrow-up-down-line"></i>
                        <span>Recents Taches</span>
                     </a>';
                        }
                     ?>
                      ...
                      <?php 
                        if ($type == 'client' ) {
                            echo '<a href="#" class="sidebar__link"  onclick="showiframe(\'apercus\',\'evenement_recent.php\')">
                        <i class="ri-arrow-up-down-line"></i>
                        <span>Recents évènements</span>
                     </a>';
                        }
                     ?>
                     <?php 
                     ...
                     <?php 
                        if ($type == 'client') {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'acteur_client.php\')">
                     ...
                     <?php 
                        if ($type == 'admin') {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'gerer_utilisateurs.php\')">
                        <i class="bx bx-line-chart"></i>
                     ...
                     <?php 
                        if ($type == 'acteur') {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'liste_apercus_acteur.php\')">
                        <i class="bx bx-line-chart"></i>
                           <span>Apercus</span>
                     </a>';
                        }
                    ...
                    <?php 
                        if ($type == 'acteur') {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'apercus_acteur.php\')">
                        <i class="bx bx-line-chart"></i>
                           <span>Ajouter un apercus</span>
                     </a>';
                        }
                     ?>
                  </div>
               ...
               <div>
                  ...
                  <div class="sidebar__list">
                     ...
                     <?php 
                        if ($type == 'admin' ) {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'notification_admin.php\')">
                        <i class="ri-notification-2-fill"></i>
                        <span>Notifications</span>
                     </a> ';
                        }
                     ...
                     <?php 
                        if ($type == 'admin' ) {
                            echo '<a href="#" class="sidebar__link" onclick="showiframe(\'apercus\',\'save_admin.php\')">
                        <i class="bx bx-plus"></i>
                        <span>Alouter un Admin</span>
                     </a> ';
                        }
                     ?>
                  </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Ajoutez un script pour changer la source de l'iframe après la POST
    echo '<script>
        // Vérifier si l’iframe avec ID "apercus" existe
        const iframeApercus = document.getElementById("apercus");
        if (iframeApercus) {
            // Mettre la source à recherche.php
            iframeApercus.src = "recherche.php";
            iframeApercus.style.display = "block";
        }
    </script>';
}
?>
   ...
   <script src="http://translate.google.com/translate_a/element.js?cb=loadGoogleTranslate"></script>
    <script type="text/javascript">
        function loadGoogleTranslate(){
            new google.translate.TranslateElement("google_language_change"); 
        }
    </script>
</html>