...
$result_notifications = $mysqli->query(
    "SELECT * FROM notification_admin  ORDER BY id DESC"
);
    ...
    <?php foreach ($notifications as $notif): ?>
        <div class="notification" data-id="<?php echo $notif['id']; ?>">
            ...
            <div class="message">
                ...
                <div class="timestamp">Envoyé le : <?php echo htmlspecialchars(isset($notif['date_ajout']) ? $notif['date_ajout'] : ''); ?></div>
            </div>
            <div class="actions">
...
function deleteNotification(id, element) {
    ...
    fetch('delete_notification_admin.php', {
        method: 'POST',
        headers: {
